...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($id_plan === 'Estándar' && $duracion_suscripcion === 'Mensual') {
        header("Location: alta_estandar_mensual.php?id=" . urlencode($id));
        exit();
    } elseif ($id_plan === 'Estándar' && $duracion_suscripcion === 'Anual') {
        header("Location: alta_estandar_anual.php?id=" . urlencode($id));
        exit();
    } elseif ($id_plan === 'Premium' && $duracion_suscripcion === 'Mensual') {
        header("Location: alta_premium_mensual.php?id=" . urlencode($id));
        exit();
    } elseif ($id_plan === 'Premium' && $duracion_suscripcion === 'Anual') {
        header("Location: alta_premium_anual.php?id=" . urlencode($id));
        exit();
    }
